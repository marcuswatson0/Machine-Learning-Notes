...
Using Lambda function to turn column values into categories 
...
Building one dimensional PCA (Principal component analysis)
...
Basic Deep Learning Model to predict the digit in the image (MNIST Data set)
